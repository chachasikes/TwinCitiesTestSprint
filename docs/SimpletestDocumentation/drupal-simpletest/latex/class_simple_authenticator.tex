...
\subsubsection[{addBasicHeaders}]{\setlength{\rightskip}{0pt plus 5cm}SimpleAuthenticator::addBasicHeaders (\&\$ {\em request}, \/  \$ {\em username}, \/  \$ {\em password})\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
